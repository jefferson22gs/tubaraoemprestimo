...
import { DollarSign, Users, AlertTriangle, TrendingUp, Check, X, Maximize, Layers, Activity } from 'lucide-react';
    ...
    return (
        <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl hover:border-[#D4AF37]/30 transition-all hover:scale-105 duration-300">
            ...
            <span className={`text-xs font-bold px-2 py-1 rounded-full ${
                (trend.includes('-') && !isBad) || (!trend.includes('-') && isBad === undefined)
